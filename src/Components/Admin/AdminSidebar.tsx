...
import Logo from '/users/Logo2.png';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
 const dispatch=useDispatch()
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999   flex h-screen w-72.5 flex-col overflow-y-hidden bg-gray duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/admin"
                  className={`group dark:text-gray hover:text-gray relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group dark:text-gray hover:text-gray relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/' ||
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/chart"
                  className={`group relative dark:text-gray hover:text-gray flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative dark:text-gray hover:text-gray flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out dark:text-gray hover:text-gray hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/auth' || pathname.includes('auth')) &&
                          'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <button onClick={handleLogout}
                              className=
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 dark:text-gray duration-300 ease-in-out  ' 
