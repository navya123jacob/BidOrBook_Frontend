...
const TravelSection: React.FC<TravelSectionProps> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 bg-blue-900 overflow-y-auto transform translate-y-full transition-transform duration-300">
      <div className="absolute top-5 right-5 w-8 h-8 cursor-pointer transition-transform duration-200 transform hover:rotate-90" onClick={onClose}>
