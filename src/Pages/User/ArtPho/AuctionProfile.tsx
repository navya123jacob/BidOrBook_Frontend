      ...
      <main className="bg-black text-white min-h-screen">
        <div className="lg:w-8/12 lg:mx-auto mb-8">
          <header className="flex flex-col items-center p-4 md:py-8">
            {!userInfo.client && (<div className="mb-4">
              <FontAwesomeIcon icon={faPlus} className="text-3xl text-white" onClick={() => setIsAuctionModalOpen(true)} />
            </div>)}
            ...
            <ul className="hidden md:flex space-x-8 mb-4">
                <li>
                <span className="font-semibold">{auctions.length}</span> {auctions.length>1?'auctions':'auction'}
                </li></ul>
          </header>
          <div className="px-px md:px-3">
            <ul className="flex md:hidden justify-around space-x-8 border-t text-center p-2 text-white leading-snug text-sm">
              <li>
                <span className="font-semibold block text-white">{auctions.length}</span> auctions
              </li>
            </ul>
